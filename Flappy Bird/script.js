...
function preload() {
  ...
  this.load.image("character1","yellowbird-midflap.png");
  this.load.image("character2","yellowbird-downflap.png");
  this.load.image("character3","yellowbird-upflap.png");
  this.load.image("character4","yellowbird-fall.png");
  this.load.image("pillar","pipe-green.png");
  this.load.image("base","base.png");
  this.load.image("gameover","gameover.png");
  this.load.image("score","score.png");
  this.load.image("retry","retry.png");
  this.load.image("startGame","message.png");
  this.load.audio("score","point.wav");
  this.load.audio("hit","hit.wav");
  this.load.audio("wing","wing.wav");
